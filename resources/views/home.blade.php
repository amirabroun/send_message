                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ route('admin') }}" class="underline text-gray-900 dark:text-white">admin</a></div>
                            </div>
                        </div>
                        <div class="p-6">
                            <div class="flex items-center">
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ route('user') }}" class="underline text-gray-900 dark:text-white">user</a></div>
                            </div>
                        </div>
                    </div>
                </div>
